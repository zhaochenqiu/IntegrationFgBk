...
aligimg = aligMap_tar2src(grayimg_cur,map_img2model);

global threshold_gmm;

[compare fgimg similary] = getFgImage(aligimg,mus,sigmas,weights,threshold_gmm);

[mus sigmas weights] = updateBkImage(aligimg,mus,sigmas,weights,compare);
