...
global range_multi;
[map_model2img map_model2img_single] = getMapRange_multi_model2img_double(grayimg_cur,bkimg,store_list,store_transform,labels_img,range_multi,H_full);
...
mus_up_fg      = aligmentImg_byMap_model2img(mus,map_model2img_single);
sigmas_up_fg   = aligmentImg_byMap_model2img(sigmas,map_model2img_single);
weights_up_fg  = aligmentImg_byMap_model2img(weights,map_model2img_single);
