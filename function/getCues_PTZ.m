...
global range_single;
map_img2model = getMapRange_multi_model2img(grayimg_cur,bkimg,store_list,store_transform,labels_img,range_single,H_full);

mus_fg      = aligmentImg_byMap_model2img(mus,map_img2model);
sigmas_fg   = aligmentImg_byMap_model2img(sigmas,map_img2model);
weights_fg  = aligmentImg_byMap_model2img(weights,map_img2model);
...
map_img2model = getMapRange_multi(grayimg_cur,bkimg,store_list,store_transform,labels_img,range_single_fg,H_full);
...
re_fgmodel = {mus_fg,sigmas_fg,weights_fg};
