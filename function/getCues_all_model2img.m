function [re_fgcues re_bkcues re_H re_tempimgfg re_tempimgbk re_fgmodel re_bkmodel] = getCues_model2img_img2model_bk(img_cur,model)
...
global range_single;
% map_model2img = getMapRange_multi_model2img(grayimg_cur,bkimg,store_list,store_transform,labels_img,range_single,H_full);

mus_fg      = aligmentImg_byMap_model2img(mus,map_model2img);
sigmas_fg   = aligmentImg_byMap_model2img(sigmas,map_model2img);
weights_fg  = aligmentImg_byMap_model2img(weights,map_model2img);
...
map_img2model = getMapRange_multi_model2img(grayimg_cur,bkimg,store_list,store_transform,labels_img,range_single_fg,H_full);

mus_up_fg      = aligmentImg_byMap(mus,map_img2model);
sigmas_up_fg   = aligmentImg_byMap(sigmas,map_img2model);
weights_up_fg  = aligmentImg_byMap(weights,map_img2model);

[mus_up_fg sigmas_up_fg weights_up_fg] = reInitiaModel(img_cur,mus_up_fg,sigmas_up_fg,weights_up_fg);

oldfgimg_fg = fgimg_fg;
...
re_tempimgfg = getBestBkImage(mus_fg,weights_fg);
