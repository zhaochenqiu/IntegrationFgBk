function [re_fgcues re_bkcues re_model re_H] = getCues_FgBk(img_cur,model)
...
global fgcues_range bkcues_range;
map = getMapRange_single_op(grayimg_cur,bkimg,H_full,fgcues_range);
...
for label = minnum:maxnum
    ...
    [H src tar ok] = getHomography_ransac(tempx_cur,tempx_pre,bkcues_range);
