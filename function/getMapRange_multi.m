function re_map = getMapRange_multi(img_tmp,img_tar,label_list,H_list,label_img,range,H_error)
    ...
    for j = 1:column_img
        ...
        if posx > 0 & posx < column_img + 1 & posy > 0 & posy < row_img + 1
            ...
            if (re_map(i,j,1) == -1)
                ...
                oldsub = abs(value - img_tar(oldmapy,oldmapx));
                newsub = abs(value - img_tar(mapy,mapx));
